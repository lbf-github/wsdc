    ...
    $.ajaxFileUpload({
        ...
        success : function(data){        // 服务器响应成功时的处理函数
        	...
        	if (datajson.code == "1000" ) {
        		$("#image").append('<div class="bb004"><img style="height:150px;width:150px;margin-left:15px" src="'+imgUrl+datajson.msg+'">'+
        		'<div class="bb003" onclick="removeImgPic(this)"></div><input type="hidden" name="img_id" value="'+datajson.msg+'"/><input value="http://" placeholder="图片链接" style="width:156px;" name="link"></div>');
        	}
        },
