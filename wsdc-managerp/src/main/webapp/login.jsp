...
<body onload="javascript:to_top()"
	style="background-image: url('${pageContext.servletContext.contextPath }/admin_files/hun.jpg');margin-top:0px;background-repeat:no-repeat;background-size: 100% auto;">
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly" style="background: #28b779"><img
							...
							alt="请输入账号.."></span><input type="text" placeholder="请输入用户名" name="username"
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly"><img
							...
							alt="请输入密码.."></span><input type="password" placeholder="请输入密码" name="password"
							onkeydown="keyLogin();" style="height: 32px; margin-bottom: 0px;"/>
					</div>
				</div>
			</div>
			<div class="form-actions">
				<span class="pull-left" style="width: 33%">
				<a href="#" class="flip-link btn btn-info" id="to-recover">忘记密码？</a></span>
				<!-- <span class="pull-left" style="width: 33%"> -->
				<!-- <a href="install.shtml" class="flip-link btn btn-danger" id="to-recover">一键初始化系统</a></span> -->
				<span class="pull-right">
				<a id="login" href="javascript:checkUserForm()" class="btn btn-success">登&nbsp;&nbsp;录</a></span>
			</div>
		</form>
	</div>
