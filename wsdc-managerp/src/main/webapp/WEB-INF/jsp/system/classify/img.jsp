...
<script type="text/javascript" src="${ctx}/js/system/classify/img.js"></script>
</head>
<body>
	<div class="l_err" style="width: 100%; margin-top: 2px;"></div>
	<form id="imgForm" name="form" class="form-horizontal" method="post" action="${ctx}/classify/viewImg.shtml">
