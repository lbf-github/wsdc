...
<body>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9" id="area">
						<select id="province_id" required onchange="getCities();" name="activityFormMap.province_id" class="form-control m-b"
							tabindex="-1">
						</select>
						<select id="city_id" required name="activityFormMap.city_id" class="form-control m-b city_id" tabindex="-1"></select>
					</div>
				</div>
	...
	<script type="text/javascript">
		getProvince("${activity.province_id}");
		getCity("${activity.province_id}","${activity.city_id}");
	</script>
</body>
</html>