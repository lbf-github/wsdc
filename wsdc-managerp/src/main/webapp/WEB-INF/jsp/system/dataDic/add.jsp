...
<script type="text/javascript" src="${ctx}/js/system/dataDic/add.js"></script>
<style type="text/css">
	#but button {
		margin-bottom: 5px;
		margin-right: 5px;
...
<body>
	...
	action="${pageContext.request.contextPath}/dataDic/addEntity.shtml">
	<section class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select id="parentId" name="dataDicFormMap.parentId" class="form-control m-b"
						tabindex="-1">
					</select>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input id="gritter-light" type="checkbox" name="dataDicFormMap.ishide" id="ishide" class="ace ace-switch ace-switch-5" value="1">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" minlength="1" maxlength="100" required
						placeholder="请输入描述" name="dataDicFormMap.description" id="description">
				</div>
			</div>
		</div>
