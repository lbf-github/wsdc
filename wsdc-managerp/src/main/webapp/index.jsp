									...
									<ul class="nav">
										<c:forEach var="key" items="${list}" varStatus="s">
											...
											<li>
												...
												<c:if test="${s.index==4}">
													<i class="fa fa-dashboard icon"> <b class="bg-success"></b></i>
												</c:if> 
												<c:if test="${s.index==5}">
													<i class="fa fa-th-list icon"> <b class="bg-primary"></b></i>
												</c:if> 
												<c:if test="${s.index==6}">
													<i class="fa fa-pencil-square icon"> <b class="bg-danger"></b></i>
												</c:if> 
												<c:if test="${s.index==7}">
													<i class="fa fa-book icon"> <b class="bg-primary"></b></i>
												</c:if> 
												<c:if test="${s.index==8}">
													<i class="fa fa-pencil-square icon"> <b class="bg-success"></b></i>
												</c:if>
												<c:if test="${s.index==9}">
