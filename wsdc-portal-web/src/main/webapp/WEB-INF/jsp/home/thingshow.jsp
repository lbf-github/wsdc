        ...
        <tr>
           ...
           <td style="width:20px"></td>
            ...
            <div class="mainborder">
                ...
                <ul class="jinmes">
                    <li>菜名：${thing.name}</li>
                    <li>地域：${thing.thingtype.type}</li>
                    <li>类别：${thing.thingtype2.type}</li>
                    <li>价格：${thing.price}元</li>
                    <li>餐馆：${thing.shop.name}</li>
                    <li><input type="button" id="buy" style="display:block; width:68px; heigth:30px; background:url(${basePath}images/buy.jpg); border-width:0px;" /></li>
                </ul> 
                </div>
                <div class="content">
                	${thing.content}
