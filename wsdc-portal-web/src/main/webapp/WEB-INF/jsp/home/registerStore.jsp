...
<div class="layui-form-item">
    <label class="layui-form-label">商家名称</label>
    <div class="layui-input-block">
      <input id="storename" name="storename" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input" type="text" value="">
      ...
      <div class="layui-form-item">
          ...
          <div class="layui-input-block">
              <input id="address" name="address" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input" type="text" value="">
              <%--<input id="userid" name="userid" type="hidden" value="${user.userid}">--%>
          </div>
      </div>
  <%--<div class="layui-form-item">--%>
  ...
  <%--</div>--%>
      ...
      <div class="layui-form-item">
          ...
          <div class="layui-input-block">
              <input id="latlng" name="latlng" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input" type="text" value="">
              <%--<input id="userid" name="userid" type="hidden" value="${user.userid}">--%>
          </div>
      </div>
  <div class="layui-form-item">
   ...
   //监听提交
     form.on('submit(demo1)', function(data){
         var _ticket = $.cookie("login_token");
	       $("#edit").form("submit",{
				url : "${ctx}/storeInfo/doRegisterStore.do?tokenId="+_ticket,
				onSubmit : function() { },
