...
<html>
  ...
  <table class="layui-table">
    ...
    <tbody>
    <c:forEach var="list"  items="${myOrdersList}">
      <tr>
        ...
        <td>
            <c:if test="${list.comment != '' and list.comment != null}">
                ${list.comment}
            </c:if>
            <c:if test="${list.comment == '' or list.comment == null}">
                <input type="button" class="buy" value="评论" onclick="doComment(${list.orderid})"/>
            </c:if>
        </td>
      </tr>
      </c:forEach>
